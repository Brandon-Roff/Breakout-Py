...
class Breakout():
    ...
    def main(self):
        ...
        bat_speed = 30
        score = 0 
        bgcolour = 0x0, 0x0, 0x0  # darkslategrey        
        ...
        while 1:
            ...
            if ballrect.top > height:
                ...
                if lives == 0:                    
                    msg = pygame.font.Font(None,70).render("Game Over", True, (209, 0, 0), bgcolour)
            ...
            screen.fill(bgcolour)
            scoretext = pygame.font.Font(None,40).render(str(score), True, (209, 0, 0), bgcolour)
